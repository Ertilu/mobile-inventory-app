...
const AddProductStack = createStackNavigator({
  AddProduct: {
    ...
    navigationOptions: ({ navigation }) => ({
      header: <Header title="Add Product" navigation={navigation} />,
    })
  },
}, {
  cardStyle: { backgroundColor: '#EEEEEE', },
...
const HomeStack = createStackNavigator({
  ...
  Pro: {
    screen: ProScreen,
    navigationOptions: ({navigation}) => ({
      header: <Header white transparent title="Product Detail" navigation={navigation} />,
      headerTransparent: true,
    })
  },
},
...
const LogoutStack = createStackNavigator({
  Logout: {
    screen: Logout,
    // navigationOptions: ({navigation}) => ({
    //   header: <Header title="Logout" navigation={navigation} />,
    // })
  },
},
{
...
const AppStack = createDrawerNavigator(
  {
    ...
    AddProduct: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="AddProduct" title="Add Product" />
        ),
      }),
    },
    Settings: {
